...
│   └── main.py             # tailor, config, profile commands
...
- Grounding constraint is enforced via explicit system-level instruction: _"You may only reference skills, experience, and facts present in the provided resume JSON. Do not invent or imply anything not present."_
